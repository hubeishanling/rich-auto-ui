...
## 📖 项目解决的痛点（主要针对多模块项目）
 1. 脚本打包成应用时，源码加密，别人无法拿到你的源码数据。
 2. 集成vue2+vant，可以直接用vue进行开发
 3. 脚本项目需要更新版本的时候，可以把脚本项目打包成**插件**，然后更新，极大的缩小了更新包的大小。
 4. 集成登录相关逻辑，包括卡密验证、脚本更新、与后端的通信加密。所以整体来说，是一套很优秀的Autojs的前端框架模板，极大的缩减脚本开发后期的变现时间，并且让脚本的安全性得到了极大的保证。（RSA+AES联合加密通信数据）
 5. 官方提供配套后端，可以同时管理多个游戏脚本的更新，管理多个游戏脚本的卡密。
 6. 前端代码全部开源，无任何加密。
